...
function NotFound() {
  return (
    <Section className=''>
      <div className='grid grid-cols-1 md:grid-cols-12 mt-10 gap-10 pt-10'>
        <div className='col-span-1 md:col-span-12 text-zinc-800 dark:text-zinc-500 text-center'>
        ...
        <div className='col-span-1 md:col-span-12 text-zinc-800 dark:text-zinc-500 text-center'>
          <div className=''>
            <h2 className='text-4xl md:text-5xl font-jetBrainsExtraBold mt-16 px-8'>
