        ...
        <div className='transition-colors duration-1000 ease-in-out'>
          <nav className='hidden lg:block h-full ml-auto'>
            <ul className='z-50 flex items-center'>
              ...
              <a
                href='#'
                className='text-lg text-zinc-950 dark:text-zinc-400 hover:border-b-2 hover:border-yellow-400 dark:hover:border-yellow-400 transition duration-200 ease-out'
              >
                01_ Home
              </a>
            </li> */}
              <li className='z-50 mx-5 lg:inline-block'>
                <Link
                  ...
                  offset={-40}
                  duration={500}
                  className='text-md text-zinc-950 dark:text-zinc-400 hover:font-jetBrainsExtraBold dark:hover:text-yellow-400 transition duration-200 ease-out cursor-pointer'
                >
              ...
              <li className='z-50 mx-5 lg:inline-block'>
                <a href='/CV/Krisztian-Nemeth-CV.pdf' download>
